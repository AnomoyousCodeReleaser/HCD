...
import torchvision
import torch
from hcd.models.pooling import *
from hcd.utils.serialization import load_checkpoint
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
                 num_features=0, norm=False, dropout=0, num_classes=0,model=None):
        ...
        if model is not None:
            ...
            model_0 = torch.load(model, map_location=lambda storage, loc: storage, pickle_module=pickle)
            resnet.load_state_dict(model_0['state_dict'],strict=False)
            print("Done")
